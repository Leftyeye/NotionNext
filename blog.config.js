...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '左椰椰', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '左椰椰的web3工具箱', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://leftyeye.cc', // 网站地址
